...
<?php }?>	
<p class="raindrops-mobile-menu" ><a href="#access" class="open" style="color:#<?php echo $obandes_text_color;?>">+</a><span class="menu-text" style="color:#<?php echo $obandes_text_color;?>">menu</span><a href="#<?php echo obandes_get_condition('letter-width'); ?>" class="close" style="color:#<?php echo $obandes_text_color;?>">-</a></p>
